...
export class LauncherIconGenerator extends BaseGenerator {
    ...
    regenerate() {
        ...
        this.zipper.add({
            name: "1024.png",
            canvas: this.regenerateRaw_({ mult: 1024 / 48, fullBleed: true })
                .canvas,
        });
    ...
    regenerateRaw_({ mult, fullBleed, adaptive }) {
        ...
        let foregroundLayer = {
            ...
            draw: (ctx) => {
                ...
                let drawFn_ =
                    studio.Drawing[
                        values.crop ? "drawCenterCrop" : "drawCenterInside"
                    ];
